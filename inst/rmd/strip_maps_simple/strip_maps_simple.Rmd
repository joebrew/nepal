...
library(knitr)
library(kableExtra)
knitr::kable(x, format = 'latex', booktabls = 'T') %>%
...
This appendeix contains visuals of and data relating to planned flights in Pyuthan for the period from January 2019 through September 2019.
