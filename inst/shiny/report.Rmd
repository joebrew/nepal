...
if(country == 'Nepal'){
  ...
  fiana_fortified <- fortify(fiana, id = OBJECTID)
  madagascar_fortified <- fortify(mdg0, id = OBJECTID)
...
g1 <- ggplot(data = district_fortified,
       aes(x = long,
           y = lat)) +
  geom_polygon() +
  theme_databrew() +
...
if(country == 'Nepal'){
  ...
  test_spdf <- as(nepal::fiana_elevation_detailed, "SpatialPixelsDataFrame")
}
